    ...
    <div className="flex min-h-[calc(100vh-4rem)] flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
            For demo purposes, use <span className="font-mono bg-gray-200 px-1 rounded">admin@shop.com</span> / <span className="font-mono bg-gray-200 px-1 rounded">admin</span>
        </p>
      </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-white px-2 text-gray-500">New to ModernShop?</span>
              </div>
            </div>
